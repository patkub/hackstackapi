...
$(function () {
  ...
  (function (hackstack) {
    var navbar = new HackStackNavBar("addCustomer");
    var footer = new HackStackFooter(); // render the navbar and footer

    $("#navbar").append(navbar.render());
    $("#footer").append(footer.render()); // mask input phone numbers

    $("#inputHomePhone").inputmask({
      "mask": "(999) 999-9999"
    });
    $("#inputMobilePhone").inputmask({
      "mask": "(999) 999-9999"
    });
    /**
    ...
    $("#addNewCustomer").submit(function (e) {
      ...
      $.post(hackstack.API_SERVER + "customers/add", data).done(function (msg) {
        // successfully added
