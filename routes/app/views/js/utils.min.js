...
})([Element.prototype, Document.prototype, DocumentFragment.prototype]) // our app
;

(function (hackstack) {
  // the Java api
  hackstack.API_SERVER = "http://" + window.location.hostname + ":8080/"; // the express.js api wrapper used for game search
  ...
  function alertSuccess(html) {
    $("#alert").removeClass("d-none").removeClass("alert-danger").addClass("alert-success").html(html);
  }
  /**
  ...
  function alertDanger(html) {
    $("#alert").removeClass("d-none").removeClass("alert-success").addClass("alert-danger").html(html);
  }
  /**
  ...
  function showRentalItemSmallOverlay(itemID, text) {
    var overlay = $("#rentalItemSmallOverlay{0}".format(itemID));
